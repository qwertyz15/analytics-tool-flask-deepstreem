...
SOAP_FMAC1 char* SOAP_FMAC2 soap_string_in2(struct soap*, int, long, long);
...
SOAP_FMAC1 wchar_t* SOAP_FMAC2 soap_wstring_in2(struct soap*, int, long, long);
#endif
...
SOAP_FMAC1 char** SOAP_FMAC2 soap_instring2(struct soap*, const char *tag, char **p, const char *, int, int, long, long);
#ifndef WITH_LEAN
