...
char *
SOAP_FMAC2
soap_string_in2(struct soap *soap, int flag, long minlen, long maxlen)
{ register char *s;
  char *t = NULL;
  register size_t i;
  register long l = 0;
...
wchar_t *
SOAP_FMAC2
soap_wstring_in2(struct soap *soap, int flag, long minlen, long maxlen)
{ wchar_t *s;
...
char **
SOAP_FMAC2
soap_instring2(struct soap *soap, const char *tag, char **p, const char *type, int t, int flag, long minlen, long maxlen)
{ (void)type;
  ...
  { *p = soap_string_in2(soap, flag, minlen, maxlen);
