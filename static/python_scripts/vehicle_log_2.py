...
rootpath  = '/media/sigmind/watchcam-data/survey_video_extract/Location10'
locBase = os.path.basename(rootpath)
try:
    os.mkdir(locBase)
except:
    pass

cams = os.listdir(rootpath)
