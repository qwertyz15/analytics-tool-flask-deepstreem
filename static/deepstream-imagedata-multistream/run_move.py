...
try:
    ...
    pass
DIR_PATHS = [root_dir + "Cam1", root_dir + "Cam2", root_dir + "Cam3", root_dir + "Cam4", root_dir + "Cam5"]
os.system('''rsync -av -f"+ */" -f"- *" "/media/sigmind/watchcam-data/all_high_way_concatenated_mp4/" "/media/sigmind/watchcam-data/Survey_video_completed"''')
...
while not NO_VIDEOS:
    ...
    for cam in z:
        ...
        replacedPath = cam.replace("all_high_way_concatenated_mp4","Survey_video_completed")
        # os.mkdir(os.path.dirname(replacedPath), exist_ok = True)
        # rsync -av -f"+ */" -f"- *" "/media/sigmind/watchcam-data/all_high_way_concatenated_mp4/" "/media/sigmind/watchcam-data/Survey_video_completed"
        shutil.move(cam, os.path.dirname(replacedPath))
